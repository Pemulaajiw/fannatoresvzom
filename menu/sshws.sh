...
clear
echo -e "$COLBG1 $WH• SSH PANEL MENU • $COLBG1"
echo -e "$COLOR1[$WH 01 $COLOR1]  ${WH}Check Users Login"
echo -e "$COLOR1[$WH 02 $COLOR1]  ${WH}Create Accounts"
echo -e "$COLOR1[$WH 03 $COLOR1]  ${WH}Delete Accounts"
echo -e "$COLOR1[$WH 04 $COLOR1]  ${WH}Renew Accounts"
echo -e "$COLOR1[$WH 05 $COLOR1]  ${WH}Trial Accounts"
echo -e "$COLOR1[$WH 06 $COLOR1]  ${WH}Lock Accounts"
echo -e "$COLOR1[$WH 07 $COLOR1]  ${WH}Unlock Accounts"
echo -e "$COLOR1[$WH 08 $COLOR1]  ${WH}Detail Account"
echo -e "$COLOR1[$WH 09 $COLOR1]  ${WH}Setting Lock Account"
echo -e "$COLOR1[$WH 10 $COLOR1]  ${WH}Change IP Limit Accounts"
