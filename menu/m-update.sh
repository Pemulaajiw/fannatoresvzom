...
wget -q -O /usr/bin/update "https://raw.githubusercontent.com/Pemulaajiw/fannatoresvzom/refs/heads/main/menu/update.sh" && chmod +x /usr/bin/update
...
wget -q -O /usr/bin/bot2 "https://raw.githubusercontent.com/Pemulaajiw/fannatoresvzom/refs/heads/main/menu/bot2.sh" && chmod +x /usr/bin/bot2
...
wget -q -O /usr/bin/trialvless "https://raw.githubusercontent.com/Pemulaajiw/fannatoresvzom/refs/heads/main/menu/trialvless.sh" && chmod +x /usr/bin/trialvless
wget -q -O /usr/bin/trialtrojan "https://raw.githubusercontent.com/Pemulaajiw/fannatoresvzom/refs/heads/main/menu/trialtrojan.sh" && chmod +x /usr/bin/trialtrojan
