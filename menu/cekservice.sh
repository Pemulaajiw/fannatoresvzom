...
status_trgo=$(format_status "$trgoo")
status_noobz=$(format_status "$noobz")
status_vnstat=$(format_status "$vnstat_service")
status_openvpn=$(format_status "$wsovpn")
...
services=( 
  ...
  "Service OpenVPN            $status_openvpn" 
  "Service Vnstat             $status_vnstat" 
  "Service Xray Vmess WS      $status_ss" 
  "Service Xray Vless WS      $status_ss" 
  "Service Xray Trojan WS     $status_ss" 
  "Service Noobzvpns          $status_noobz" 
  "Service Trojan-Go          $status_trgo"
)
...
for service in "${services[@]}"; do
  ...
  sleep 0.6 & loading $!
    ...
    echo -e " ${PURPLE}    Script Credit By $author ${NC}"
    echo -e " ${TEAL}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
